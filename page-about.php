        ...
        <div class="ab-welcome__grid">
            ...
            <div class="ab-welcome__img-wrap">
                <div class="ab-welcome__img">
                    <?php
                    $welcome_img = get_template_directory_uri() . '/assets/images/about-welcome.jpg';
                    ?>
                ...
                <div class="ab-badge ab-badge--students">
                    ...
                    <span>1000+ Students<br>Enrolled</span>
                </div>
            </div>
            ...
            <div class="ab-welcome__content">
                ...
                <h2>A Premier Educational<br>Institution in Karachi</h2>
                <p>Beacon Academy is a dedicated educational institution located at C-1869 &amp; A-83, behind Gulzar-e-Hijri Police Station, Scheme 33, Karachi (75660). Our academy proudly serves the educational needs of students in Scheme 33, Gulzar-e-Hijri, and surrounding areas of Karachi.</p>
...
<section class="section ab-values">
    <div class="container">
        <div class="section-head">
            <span class="eyebrow"><i class="fa-solid fa-gem"></i> &nbsp;What We Stand For</span>
            <h2>Our Core Values</h2>
            <p>Everything we do is guided by these principles that shape the Beacon Academy experience.</p>
        </div>
        <div class="ab-values__grid">
            <div class="ab-val-card">
                <div class="ab-val-card__icon" style="--ic: #5b4bff;">
            ...
            <div class="ab-val-card">
                <div class="ab-val-card__icon" style="--ic: #e84393;">
            ...
            <div class="ab-val-card">
                <div class="ab-val-card__icon" style="--ic: #0ea5e9;">
            ...
            <div class="ab-val-card">
                <div class="ab-val-card__icon" style="--ic: #f59e0b;">
            ...
            <div class="ab-val-card">
                <div class="ab-val-card__icon" style="--ic: #10b981;">
            ...
            <div class="ab-val-card">
                <div class="ab-val-card__icon" style="--ic: #8b5cf6;">
        ...
        <div class="ab-campus__grid">
            ...
            <div class="ab-campus__info">
                <div class="ab-info-card">
                    ...
                    <div>
                        <h5>Address</h5>
                        <p>Scheme 33, C-1869 &amp; A-83, Behind Gulzar-e-Hijri Police Station<br>Scheme 33, Karachi – 75620</p>
                    </div>
                </div>
                <div class="ab-info-card">
                ...
                <a href="https://maps.google.com/?q=Scheme+33+Karachi" target="_blank" rel="noopener" class="btn btn--primary btn--lg" style="margin-top:8px;">
...
<section class="ab-cta-band">
    <div class="container ab-cta-band__inner">
        <div class="ab-cta-band__text">
            ...
            <h2>Ready to Start Your Journey<br>with Beacon Academy?</h2>
            <p>Join thousands of students who have achieved academic success and built bright futures with us.</p>
        </div>
