...
<section class="section ab-welcome">
    ...
    <div class="container">
        <div class="row ab-welcome__grid">
            <!-- Left: Image with floating badge -->
            <div class="ab-welcome__img-wrap col-lg-6">
            ...
            <!-- Right: Content -->
            <div class="ab-welcome__content col-lg-6">
                ...
                <ul class="row ab-checklist">
                    <li class="col-md-6"><i class="fa-solid fa-circle-check"></i> Affiliated with Zia Uddin Board</li>
                    <li class="col-md-6"><i class="fa-solid fa-circle-check"></i> Experienced &amp; Qualified Teachers</li>
                    <li class="col-md-6"><i class="fa-solid fa-circle-check"></i> State-of-the-Art Facilities</li>
                    <li class="col-md-6"><i class="fa-solid fa-circle-check"></i> Safe &amp; Supportive Environment</li>
                    <li class="col-md-6"><i class="fa-solid fa-circle-check"></i> Play Group to O/A Level</li>
                    <li class="col-md-6"><i class="fa-solid fa-circle-check"></i> Continuous Academic Guidance</li>
                </ul>
...
<div class="ab-stats">
    ...
    <div class="container">
    <div class="row ab-stats__grid">
        <div class="col-6 col-lg-3">
        <div class="ab-stat-item ab-stat-item--purple d-flex align-items-center gap-3 h-100">
        ...
        <div class="col-6 col-lg-3">
        <div class="ab-stat-item ab-stat-item--green d-flex align-items-center gap-3 h-100">
        ...
        <div class="col-6 col-lg-3">
        <div class="ab-stat-item ab-stat-item--gold d-flex align-items-center gap-3 h-100">
        ...
        <div class="col-6 col-lg-3">
        <div class="ab-stat-item ab-stat-item--blue d-flex align-items-center gap-3 h-100">
...
<section class="section ab-mv">
    <div class="container">
        ...
        <div class="row ab-mv__grid">
            <!-- Mission -->
            <div class="col-lg-6">
            <div class="ab-mv-card ab-mv-card--mission h-100">
            ...
            <!-- Vision -->
            <div class="col-lg-6">
            <div class="ab-mv-card ab-mv-card--vision h-100">
                <div class="ab-mv-card__top-bar"></div>
                <div class="ab-mv-card__body d-flex flex-column">
                    <div class="ab-mv-card__icon">
...
<section class="section ab-values">
    ...
    <div class="container">
        ...
        <div class="row ab-values__grid">
            <div class="col-12 col-md-6 col-lg-4">
            <div class="ab-val-card d-flex align-items-start h-100" style="--ic:#5b4bff;">
            ...
            <div class="col-12 col-md-6 col-lg-4">
            <div class="ab-val-card d-flex align-items-start h-100" style="--ic:#e84393;">
            ...
            <div class="col-12 col-md-6 col-lg-4">
            <div class="ab-val-card d-flex align-items-start h-100" style="--ic:#0ea5e9;">
            ...
            <div class="col-12 col-md-6 col-lg-4">
            <div class="ab-val-card d-flex align-items-start h-100" style="--ic:#f59e0b;">
            ...
            <div class="col-12 col-md-6 col-lg-4">
            <div class="ab-val-card d-flex align-items-start h-100" style="--ic:#10b981;">
            ...
            <div class="col-12 col-md-6 col-lg-4">
            <div class="ab-val-card d-flex align-items-start h-100" style="--ic:#8b5cf6;">
...
<section class="section ab-campus" id="campus">
    <div class="container">
        ...
        <div class="row ab-campus__grid">
            <div class="ab-campus__map col-lg">
            ...
            <div class="ab-campus__info col-lg d-flex flex-column">
